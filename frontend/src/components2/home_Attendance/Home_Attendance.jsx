...
const Home_Attendance = () => {
  ...
  useEffect(() => {
    console.log("Home_Attendance: Checking auth", { authUserId, authToken });
    window.scrollTo(0, 0);
    if (!authUserId || !authToken) {
      console.log("Home_Attendance: Redirecting to /signin");
      navigate("/signin");
    }
  }, [navigate, authUserId, authToken]);

  const handleCreateProject = () => {
    console.log("Home_Attendance: handleCreateProject", {
      authUserId,
      authToken,
    });
    window.scrollTo(0, 0);
    ...
    <>
      ...
      <div className="field-attendance-container">
        ...
        <header className="attendance-header">
          ...
          <p>
            Manage your field projects and track team attendance efficiently.
          </p>
        </header>
        ...
        <div className="get-started-section">
          ...
          <p className="instruction-text">
            Create your first field project to get started with attendance
            tracking
          </p>
        </div>
      </div>
